<?php
    ...
    $sql = "SELECT tecniche.tecnica, artisti.cognome AS cognome,quadri.titolo,quadri.prezzo,quadri.altezza,quadri.larghezza,quadri.immagine FROM quadri
    JOIN artisti ON quadri.id_artista=artisti.ID_Artista JOIN tecniche ON tecniche.ID_tecnica=quadri.id_tecnica WHERE quadri.ID_quadro=$id_quadro;";
...
<div class="dettagli">
    ...
    <div class="input-group mb-3">
        <span class="input-group-text" id="basic-addon1">Tecnica</span>
        <input type="text" class="form-control" value="<?php echo $records['tecnica'] ?>" readonly>
    </div>
    <div class="input-group mb-3">
